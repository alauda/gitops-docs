...
- <ExternalSiteLink name="container_platform" href="/observability/monitor/install_monitor.mdx" children="Installation of Monitoring Plugins" />。
...
:::info
For other parameter configurations and alert settings, refer to <ExternalSiteLink name="container_platform" href="/observability/monitor/functions/manage_alert.mdx" children="Alert Management" />。
:::

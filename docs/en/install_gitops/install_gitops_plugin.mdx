...
Click **Help Document** on the right to get instructions on how to publish the cluster plugin to `global` cluster. For more details, please refer to <ExternalSiteLink name="container_platform" href="/ui/cli_tools/index.mdx" children="CLI" />.
:::
